...
@Transactional
class NotUsefulReviewIntegrationTest {
    ...
    @Test
    void recordsNotUsefulFeedbackAndArchivesTheNote() throws Exception {
        ...
        assertThat(jdbcTemplate.queryForObject(
                ...
                where note_id = ? and user_id = ? and feedback_type = 'NOT_USEFUL'
                """,
                Integer.class,
                note.getId(),
                user.getId()
